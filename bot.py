...
def bot(op):
    try:
        ...
        if op.type == 25:
		    ...
		    ki.sendText(msg.to, "Siap 􀜁􀅹Salute􏿿")
                    kk.sendText(msg.to, "Siap 􀜁􀅹Salute􏿿")
                    kc.sendText(msg.to, "Siap 􀜁􀅹Salute􏿿")
                    try:
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Hi juga 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Hi juga 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Hi juga 􀜁􀅔Har Har􏿿")

#-----------------------------------------------
            elif msg.text in ["Welcome"]:
                ki.sendText(msg.to,"Selamat datang di Grup ini 􀨁􀄻double thumbs up􏿿")
                kk.sendText(msg.to,"Jangan nakal oke 􀨁􀄻double thumbs up􏿿")
#-----------------------------------------------
